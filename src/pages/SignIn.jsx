        ...
        <div className="bg-white rounded-2xl shadow-lg p-8 border border-slate-200">
          ...
          <form className="space-y-5" onSubmit={handleSubmit}>
            <div>
              ...
              <input id="email" name="email" type="email" required
                className="w-full px-3 py-2.5 border border-slate-200 bg-slate-50 rounded-xl text-slate-800 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-[#582dee] focus:border-[#582dee] text-sm transition-colors"
            ...
            <div className="flex items-center justify-between">
              <label className="flex items-center gap-2 cursor-pointer">
                <input id="remember-me" name="remember-me" type="checkbox" className="h-4 w-4 rounded border-slate-300 text-[#582dee] focus:ring-[#582dee]" />
                <span className="text-sm text-slate-500">Remember me</span>
              </label>
              <a href="#" className="text-sm font-medium text-[#582dee] hover:text-[#4622c7] transition-colors">Forgot password?</a>
            </div>
          ...
          <div className="grid grid-cols-1">
            <button type="button" disabled={isGoogleLoading} onClick={handleGoogleLogin}
              className="w-full inline-flex justify-center items-center gap-2 py-2.5 px-4 border border-slate-200 rounded-xl bg-white text-sm font-medium text-slate-700 hover:border-[#582dee] hover:text-[#582dee] hover:shadow-sm disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200">
              {isGoogleLoading ? (
            ...
            {/* <button type="button"
              className="w-full inline-flex justify-center items-center gap-2 py-2.5 px-4 border border-slate-200 rounded-xl bg-white text-sm font-medium text-slate-600 hover:border-[#582dee] hover:text-[#582dee] transition-all duration-200">
          ...
          <p className="mt-6 text-center text-sm text-slate-500">
            ...
            <Link to="/sign-up" className="font-semibold text-[#582dee] hover:text-[#4622c7] transition-colors">Sign up</Link>
          </p>
        </div>
      </div>
    </div>
