...
const SignUp = () => {
  ...
  const [selectedPaymentMethod, setSelectedPaymentMethod] = useState(""); // 'direct' | 'bank' | ''
      ...
      case "assistance-payment":
        return (
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              {/* Payment Buttons in One Grid Row */}
              <div className="grid grid-cols-2 gap-3">
                ...
                <button
                  ...
                  className={`w-full px-6 py-4 font-semibold rounded-xl shadow-lg transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2 ${
                    selectedPaymentMethod === "direct"
                      ? "bg-gradient-to-r from-yellow-500 to-yellow-600 text-white hover:shadow-xl hover:from-yellow-600 hover:to-yellow-500 focus:ring-yellow-600"
                      : "border-2 border-yellow-500 text-yellow-600 bg-white hover:bg-yellow-50 focus:ring-yellow-500"
                  }`}
                >
                ...
                <button
                  ...
                  className={`w-full px-6 py-4 font-semibold rounded-xl shadow-lg transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2 ${
                    selectedPaymentMethod === "bank"
                      ? "bg-gradient-to-r from-[#027570] to-[#038a84] text-white hover:shadow-xl hover:from-[#038a84] hover:to-[#027570] focus:ring-[#027570]"
                      : "border-2 border-[#027570] text-[#027570] bg-white hover:bg-slate-50 focus:ring-[#027570]"
                  }`}
                >
                  <div className="flex items-center justify-center">
                    <svg
              ...
              {/* Show Proceed Button when payment method is selected */}
              {selectedPaymentMethod && (
                <button
                  ...
                  className="w-full px-6 py-3 bg-gradient-to-r from-green-500 to-green-600 text-white font-semibold rounded-xl shadow-lg hover:shadow-xl hover:from-green-600 hover:to-green-500 transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-green-600 focus:ring-offset-2"
                >
                  Proceed with {selectedPaymentMethod === "direct" ? "Direct Contact" : "Bank Transfer"}
                </button>
              )}
              ...
              <button
                type="button"
                onClick={goBack}
                className="w-full px-6 py-3 rounded-xl border border-slate-300 text-slate-700 font-medium hover:bg-slate-50 hover:border-slate-400 transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-[#027570] focus:ring-offset-2"
              >
                Back
              </button>
            </div>
              ...
              <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
                <div className="bg-white rounded-2xl p-6 w-full max-w-md mx-4">
                  <div className="text-center mb-4">
                    ...
                    <p className="text-slate-600">
                      Contact us directly for payment arrangement
                    </p>
                  </div>
                  ...
                  <div className="space-y-4">
                    <div className="bg-slate-50 rounded-xl p-4">
                      <div className="flex items-center mb-2">
                        <svg
                          className="w-5 h-5 text-[#027570] mr-2"
                          fill="none"
                          stroke="currentColor"
                          viewBox="0 0 24 24"
                        >
                    ...
                    <div className="bg-slate-50 rounded-xl p-4">
                      ...
                      <p className="text-slate-800">+34 900 123 456</p>
                    </div>
                  </div>
                  ...
                  <div className="flex gap-3 mt-6">
                    ...
                    <button
                      onClick={() => {
                        ...
                        toast.success(
                          "Direct contact payment selected! Please complete your registration."
                        );
                      }}
                      className="flex-1 px-4 py-2 bg-gradient-to-r from-[#027570] to-[#038a84] text-white rounded-xl hover:shadow-lg transition-all"
                    >
                      Confirm
                    </button>
                  </div>
              ...
              <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
                <div className="bg-white rounded-2xl p-6 w-full max-w-md mx-4">
                  <div className="text-center mb-4">
                    ...
                    <p className="text-slate-600">
                      Transfer €{applicationType === "personal" ? "20" : "50"}{" "}
                      to our bank account
                    </p>
                  </div>
                    ...
                    <div className="bg-slate-50 rounded-xl p-4">
                      ...
                      <div className="space-y-2 text-sm">
                        ...
                        <div>
                          ...
                          Chapman Rd, Ste 208 #22640,Newark, Delaware 19702
                          UsEIN 32-0810651
                        </div>
                        <div>
                      ...
                      <div className="flex items-start">
                        ...
                        <div>
                          ...
                          <p className="text-yellow-700 text-sm">
                            Please include your email ({formData.email}) as
                            reference
                          </p>
                        </div>
                      </div>
                  ...
                  <div className="flex gap-3 mt-6">
                    ...
                    <button
                      onClick={() => {
                        ...
                        setAssistancePaymentConfirmed(true);
                        toast.success(
                          "Bank transfer details copied! Please complete your registration after making the transfer."
                        );
                      }}
                      className="flex-1 px-4 py-2 bg-gradient-to-r from-[#027570] to-[#038a84] text-white rounded-xl hover:shadow-lg transition-all"
                    >
